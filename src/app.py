...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practice and competitive matches for soccer players",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Drills, pickup games, and league play for basketball enthusiasts",
    ...
    "Science Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["john@mergington.edu", "ava@mergington.edu"]
    }
}
